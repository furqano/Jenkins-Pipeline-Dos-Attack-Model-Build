# Jenkins-Pipeline-Dos-Attack-Model-Build

An CI-CD Pipeline to build Machine learning K-Means Dos detection models using Dockerized end-to-end approach. 
...
```
## Jenkins Job-1 - To get the WEB Server Logs and create an csv file.
![image](https://user-images.githubusercontent.com/64476159/163685589-de7643a7-fc51-41e6-8be4-fd746733a7cb.png)
